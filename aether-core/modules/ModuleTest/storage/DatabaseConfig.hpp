...
namespace ModuleTestConfig {

/**
 * @brief Configuração estática de banco de dados
 * armazenada diretamente no código-fonte...
 *
 * Isso evita JSON, arquivos externos e erros de path.
 */
...
public:
    ...
    static constexpr const char* SCHEMA   = "aether_core";
